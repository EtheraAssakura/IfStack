...
const breadcrumbs: BreadcrumbItemType[] = [
  ...
  },
  {
    ...
    href: route('sites.locations.show', {
      site: props.location.site.id,
...
<template>
  <AppSidebarLayout :title="location.name" :breadcrumbs="breadcrumbs">
    <template #header>
      <div class="flex justify-between items-center">
        ...
        <Link
          :href="route('sites.locations.edit', { site: location.site.id, location: location.id })"
              ...
              <div class="md:col-span-2">
                ...
                <div class="space-y-4">
                  <div>
                    ...
                    <p class="mt-1 text-gray-600">{{ location.site.name }}</p>
                  </div>
                  <div>
                ...
                <div class="overflow-x-auto">
                  <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      ...
                      <tr v-if="!location.stock_items || location.stock_items.length === 0">
